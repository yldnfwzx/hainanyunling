	...
	if($('#email-form').length){
		$('#submit').click(function(){
            ...
            $.ajax({
                ...
                data: $(form).serialize(),
                beforeSend:function(){
                    $('#email-form .response').html('<div class="text-info"><img src="{webroot}theme/default/images/icons/preloader.gif"> Loading...</div>');
                },
	...
	if($('#subscribe-form').length){
		$('#subscribe-newslatters').click(function(){
            ...
            $.ajax({
                ...
                data: $(form).serialize(),
                beforeSend:function(){
                    $('#subscribe-form .response').html('<div class="text-info"><img src="{webroot}theme/default/images/icons/preloader.gif"> Loading...</div>');
                },
                success:function(data){
                    $('form').trigger("reset");
